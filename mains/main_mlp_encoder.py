...
from models.model_mlp_encoder import DualStreamTransformer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="/local/scratch/bmg44/dual_stream_runs/checkpoints/mlp_encoder", help="Checkpoint directory")
