...
from trainers.trainer_with_freeze import Trainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="/local/scratch/bmg44/dual_stream_runs/checkpoints/freeze", help="Checkpoint directory")
