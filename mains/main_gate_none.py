...
from models.model_gate_none import DualStreamTransformer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="/local/scratch/bmg44/dual_stream_runs/checkpoints/gate_none", help="Checkpoint directory")
