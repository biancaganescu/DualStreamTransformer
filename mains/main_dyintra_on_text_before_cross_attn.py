...
from models.model_dyintra_on_text_before_cross_attn import DualStreamTransformer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="/local/scratch/bmg44/dual_stream_runs/checkpoints/dyintra_on_text_before_cross_attn", help="Checkpoint directory")
