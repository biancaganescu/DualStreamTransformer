...
from models.model_contrastive_loss import DualStreamTransformer
from trainers.trainer_contrastive_loss import Trainer
...
if __name__ == "__main__":
    ...
    parser.add_argument("--warmup-steps", type=int, default=6000, help="Warmup steps")
    parser.add_argument("--weight-decay", type=float, default=0.01, help="Weight decay")
    parser.add_argument("--max-epochs", type=int, default=20, help="Total epochs (text-only + image-caption)")
    parser.add_argument("--total-steps", type=int, default=5503510, help="Total training steps")
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="/local/scratch/bmg44/dual_stream_runs/checkpoints/constrastive_loss", help="Checkpoint directory")
